...
- Repository: `hoeken/signalk-frothfet-plugin`
...
- [GitHub Actions](https://github.com/hoeken/signalk-frothfet-plugin/actions) — the "Publish to npm" run is green
- [GitHub Releases](https://github.com/hoeken/signalk-frothfet-plugin/releases) — the release shows your CHANGELOG notes
- [npm](https://www.npmjs.com/package/signalk-frothfet-plugin) — the new version is live
